...
tooltip         = "CVO Auxiliary";
tooltipOwned    = "Who sold this to you?";                                                                                                          // Tool tip displayed when the mouse is left over, in the main menu
overview        = "24th Chorni Voron - Auxiliary Mod - Contains frequently used assets and Scripts used by the 24th Chorni Voron!";                 // Overview text, displayed from the extension menu
